<template>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form id="MerkForm" action="" :method="id ? 'put' : 'post'" enctype="multipart/form-data">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h1>{{ id ? "Edit" : "Add" }} Merk</h1>
                            </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            let form = [this.id ? "Edit" : "Add", "Merk"].join(" ")
            if (this.id)
            {
        ...
        methods: {
            ...
            handleDelete() {
                ...
                if (flag)
                {
                    axios.delete('/api/merk/delete/' + this.id).then((response) => {
                        console.log(response)
                        if (response.data.status)
                        {
