...
@section('content')
    <div class="row mb-1">
        <div class="col-12 col-sm-6">
            <h3 class="title">Master Cabang</h3>
                ...
                <table class="table table-striped table-hover table-bordered dataTable" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="font-weight-bold">Induk</th>
                            <th class="font-weight-bold">Wilayah</th>
...
<script>
    $(".dataTable").dataTable({
        processing: true,
        serverSide: false,
        ajax: "<?=url('branch/datatable');?>",
        columns: [
            {data: "id", name: "id"},
            {data: "branch_code", name: "branch_code"},
            {data: "branch_desc", name: "branch_desc"},
