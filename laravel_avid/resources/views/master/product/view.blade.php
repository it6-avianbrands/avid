@php
    ...
    if (isset($data)){
        ...
        $breadcrumb[1]["url"] = route("product.show",["product" => $data->ProductCode]);
    }
    
    $form_data = [
        "code" => isset($data) ? $data->ProductCode : "",
        "description" => isset($data) ? $data->ProductDesc : "",
...
@section('content')
    <div class="row mb-1">
        <div class="col-12 col-sm-6">
            <h3 class="title">Master Produk | View</h3>
